    ...
    class StarterAssetsSampleProjectValidation
    {
        ...
        static void AddRules()
        {
            if (s_BuildValidationRules.Count == 0)
            {
                ...
                // FixItAutomatic = true,
                // Error = InputSystem.actions == null && (InputSystem.actions == k_InputActionAssetName || AssetDatabase.AssetPathToGUID(AssetDatabase.GetAssetPath(InputSystem.ListInteractions)) == k_InputActionAssetGuid),
                //});
#endif
                //}
